// Keys, Queries & Values — Interactive Attention Explainer
// Demonstrates transformer self-attention on "The cat is eating"
export {};
...
function attnRow(i: number): number[] {
...
function render(): void {
  ...
  // Token chips
  document.querySelectorAll('.token-chip').forEach((c, idx) =>
  ...
  document.querySelectorAll('.hm-rh').forEach((h, idx) =>
    h.classList.toggle('hm-active', idx === i)
  );
}
