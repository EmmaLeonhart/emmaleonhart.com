...
I'm Emma, a self-taught deep-tech founder building **[Topaz](https://topazcomputing.com)**: software that learns in real time. Deeper down it's an interpretable substrate for AI, a stack of geometric tensor systems meant to be the readable alternative to opaque neural-computer runtimes, in place before the opaque version locks in. At its core is **Sutra**, my own language whose programs are vector symbolic architecture (VSA) operations compiled to tensor arithmetic; the first product built on it is a landing page that optimizes itself in real time. I built this without a PhD or a lab, on the strength of the work ([the founder story is here](https://topazcomputing.com/story)). The way I see it, Topaz is the opposite of the cloud: something you can hold and look through, not an opaque box you rent.

I treat this as a venture, not a side project: Sutra and the products built on it are a coherent stack with their own domains, a published paper, and working prototypes, and Topaz is the company I'm building around them. The usual deep-tech founder has a doctorate and an easy fallback and hedges accordingly; I have neither and I'm not building one. I went in clear-eyed about what I was giving up and committed anyway. Most of what I ship is driven by AI coding agents working inside my own scaffolding ([cleanvibe](https://github.com/EmmaLeonhart/cleanvibe)), with the judgment to know when to take the wheel. Since March 2026 I have been shipping at a pace I did not know I had, across dozens of repositories.
