...
- `/projects/` — Projects hub: the five subdomain projects (Sutra, Loka, QueryKey, Yantra, Latent Space Cartography), each linking to its own `*.emmaleonhart.com` subdomain and GitHub repo.
