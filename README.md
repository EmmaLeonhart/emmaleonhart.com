...
- `/` — Landing page: bio, flagship project (Sutra), research areas (geometric tensor languages, vector retrieval, knowledge graphs / Wikidata / Pramana), and links to the tutorial hub, theory hub, and other projects.
