...
function plotWidth() { return W - MARGIN.left - MARGIN.right; }
function plotHeight() { return H - MARGIN.top - MARGIN.bottom; }
...
function updateMathPanel() {
    ...
    for (const key of active) {
        ...
        lines.push(`<div style="margin-bottom:8px;border-left:3px solid ${color};padding-left:10px;">` +
